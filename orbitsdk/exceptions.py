...
class APIKeyError(Exception):
    def __init__(self):
        self.message = "Orbit API key needs to be defined"
...
class APIResponseError(Exception):
    ...
    requests exception error that might happen during communication with Orbit API to simplify caller coding.
    """
